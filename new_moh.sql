...
--
-- Host: localhost
-- Generation Time: Aug 22, 2025 at 01:41 PM
...
CREATE TABLE `appointments` (
  ...
  `relation_patient_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `medical_case_diagnoses` (
  ...
  `injury_side` enum('LEFT','RIGHT','MIDDLE') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `visits` (
  ...
  `status` enum('WAIT_LIST','IN_PROGRESS','DONE','TRANSFERRED','CALLED','CANCELLED') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `notes` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
...
ALTER TABLE `patients`
  ...
  ADD UNIQUE KEY `idx_unique_national` (`national_id`),
...
ALTER TABLE `patients` ADD FULLTEXT KEY `idx_ft_national` (`national_id`);
ALTER TABLE `patients` ADD FULLTEXT KEY `idx_medical` (`medical_number`);
ALTER TABLE `patients` ADD FULLTEXT KEY `idx_ft_first` (`first_name`);
ALTER TABLE `patients` ADD FULLTEXT KEY `idx_ft_last` (`last_name`);
ALTER TABLE `patients` ADD FULLTEXT KEY `idx_ft_father` (`father_name`);
ALTER TABLE `patients` ADD FULLTEXT KEY `idx_ft_mother` (`mother_name`);
ALTER TABLE `patients` ADD FULLTEXT KEY `idx_ft_phone` (`phone_number`);
...
ALTER TABLE `verification_codes`
  ADD PRIMARY KEY (`id`),
  ADD KEY `verification_codes_patient_id_foreign` (`patient_id`);
...
--
ALTER TABLE `icd_entities`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15892;

--
-- AUTO_INCREMENT for table `icd_entity_translations`
--
ALTER TABLE `icd_entity_translations`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31783;
...
--
ALTER TABLE `medicines`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13865;
...
ALTER TABLE `appointments`
  ...
  ADD CONSTRAINT `appointments_patient_id_foreign` FOREIGN KEY (`patient_id`) REFERENCES `patients` (`patient_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `appointments_relation_patient_id_foreign` FOREIGN KEY (`relation_patient_id`) REFERENCES `patients` (`patient_id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `medical_cases`
  ...
  ADD CONSTRAINT `medical_cases_patient_id_foreign` FOREIGN KEY (`patient_id`) REFERENCES `patients` (`patient_id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `patients`
  ...
  ADD CONSTRAINT `patients_relation_patient_id_foreign` FOREIGN KEY (`relation_patient_id`) REFERENCES `patients` (`patient_id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `patient_allergies`
  ...
  ADD CONSTRAINT `patient_allergies_patient_id_foreign` FOREIGN KEY (`patient_id`) REFERENCES `patients` (`patient_id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `patient_health_records`
  ...
  ADD CONSTRAINT `patient_health_records_patient_id_foreign` FOREIGN KEY (`patient_id`) REFERENCES `patients` (`patient_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
ALTER TABLE `patient_inherited_diseases`
  ...
  ADD CONSTRAINT `patient_inherited_diseases_patient_id_foreign` FOREIGN KEY (`patient_id`) REFERENCES `patients` (`patient_id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `vaccine_patients`
  ADD CONSTRAINT `vaccine_patients_patient_id_foreign` FOREIGN KEY (`patient_id`) REFERENCES `patients` (`patient_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
--
ALTER TABLE `verification_codes`
  ADD CONSTRAINT `verification_codes_patient_id_foreign` FOREIGN KEY (`patient_id`) REFERENCES `patients` (`patient_id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `visits`
  ...
  ADD CONSTRAINT `visits_patient_id_foreign` FOREIGN KEY (`patient_id`) REFERENCES `patients` (`patient_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `visits_relation_patient_id_foreign` FOREIGN KEY (`relation_patient_id`) REFERENCES `patients` (`patient_id`) ON DELETE CASCADE ON UPDATE CASCADE;
